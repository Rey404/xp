...
* REUPLOAD JUGA SILAHKAN!!
* kosong!!
*/
const XPTN = 'Raidy -Rey'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/mr.rey404'; // Nama Instagram Anda
const nomer = 'https://Wa.me/+62 896-7776-3976'; // Nomor Anda
const aktif = '24 JAM'; // bot aktif
//
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:XP Ganss\n' // full name
            + 'ORG:Owner Mr741L Bot;\n' // the organization of the contact
            + 'TEL;type=CELL;type=VOICE;waid+62 896-7776-3976=:+62 896-7776-3976\n' // WhatsApp ID + phone number
            + 'END:VCARD'
//
const
{
...
conn.sendMessage(id, ' *COMMAND PREMIUM CHAT WA https://wa.me/+62 896-7776-3976* ' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Ya?, Ketik .help/.info/.donasi Contoh .help' ,MessageType.text);
}
  ...
  var teks = text.replace(/.texthunder /, '')
    ...
    .then((res) => {
      imageToBase64(res.data.result)
        .then(
          (ress) => {
            conn.sendMessage(id, '[❗] SEDANG DI PROSES', MessageType.text)
            var buf = Buffer.from(ress, 'base64')
            conn.sendMessage(id, buf, MessageType.image)
        })
    })
